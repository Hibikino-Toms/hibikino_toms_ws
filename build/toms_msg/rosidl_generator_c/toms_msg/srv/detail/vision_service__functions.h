...
#ifndef TOMS_MSG__SRV__DETAIL__VISION_SERVICE__FUNCTIONS_H_
#define TOMS_MSG__SRV__DETAIL__VISION_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/VisionService message.
/**
...
/// Finalize srv/VisionService message.
/**
...
/// Create srv/VisionService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * toms_msg__srv__VisionService_Request__init().
...
/// Destroy srv/VisionService message.
/**
 * It calls
 * toms_msg__srv__VisionService_Request__fini()
...
/// Check for srv/VisionService message equality.
/**
...
/// Copy a srv/VisionService message.
/**
...
/// Initialize array of srv/VisionService messages.
/**
...
/// Finalize array of srv/VisionService messages.
/**
 * It calls
 * toms_msg__srv__VisionService_Request__fini()
...
/// Create array of srv/VisionService messages.
/**
 * It allocates the memory for the array and calls
 * toms_msg__srv__VisionService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VisionService messages.
/**
 * It calls
 * toms_msg__srv__VisionService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/VisionService message array equality.
/**
...
/// Copy an array of srv/VisionService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * toms_msg__srv__VisionService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_toms_msg
...
/**
 * It calls
 * toms_msg__srv__VisionService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_toms_msg
...
/**
 * It allocates the memory for the array and calls
 * toms_msg__srv__VisionService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_toms_msg
...
/**
 * It calls
 * toms_msg__srv__VisionService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TOMS_MSG__SRV__DETAIL__VISION_SERVICE__FUNCTIONS_H_
