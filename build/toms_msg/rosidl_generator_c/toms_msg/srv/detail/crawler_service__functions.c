...
toms_msg__srv__CrawlerService_Request__init(toms_msg__srv__CrawlerService_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->req_dir)) {
    toms_msg__srv__CrawlerService_Request__fini(msg);
    return false;
  }
  return true;
}
...
toms_msg__srv__CrawlerService_Request__create()
{
  ...
  toms_msg__srv__CrawlerService_Request * msg = (toms_msg__srv__CrawlerService_Request *)allocator.allocate(sizeof(toms_msg__srv__CrawlerService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(toms_msg__srv__CrawlerService_Request));
  bool success = toms_msg__srv__CrawlerService_Request__init(msg);
  if (!success) {
...
toms_msg__srv__CrawlerService_Request__Sequence__init(toms_msg__srv__CrawlerService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  toms_msg__srv__CrawlerService_Request * data = NULL;

  if (size) {
    data = (toms_msg__srv__CrawlerService_Request *)allocator.zero_allocate(size, sizeof(toms_msg__srv__CrawlerService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = toms_msg__srv__CrawlerService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        toms_msg__srv__CrawlerService_Request__fini(&data[i - 1]);
      }
...
toms_msg__srv__CrawlerService_Request__Sequence__fini(toms_msg__srv__CrawlerService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      toms_msg__srv__CrawlerService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  toms_msg__srv__CrawlerService_Request__Sequence * array = (toms_msg__srv__CrawlerService_Request__Sequence *)allocator.allocate(sizeof(toms_msg__srv__CrawlerService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = toms_msg__srv__CrawlerService_Request__Sequence__init(array, size);
  if (!success) {
...
toms_msg__srv__CrawlerService_Request__Sequence__destroy(toms_msg__srv__CrawlerService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    toms_msg__srv__CrawlerService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
toms_msg__srv__CrawlerService_Request__Sequence__are_equal(const toms_msg__srv__CrawlerService_Request__Sequence * lhs, const toms_msg__srv__CrawlerService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!toms_msg__srv__CrawlerService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  toms_msg__srv__CrawlerService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(toms_msg__srv__CrawlerService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    toms_msg__srv__CrawlerService_Request * data =
      (toms_msg__srv__CrawlerService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!toms_msg__srv__CrawlerService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          toms_msg__srv__CrawlerService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!toms_msg__srv__CrawlerService_Request__copy(
...
toms_msg__srv__CrawlerService_Response__init(toms_msg__srv__CrawlerService_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->res_dir)) {
    toms_msg__srv__CrawlerService_Response__fini(msg);
    return false;
  }
  // pulse
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  toms_msg__srv__CrawlerService_Response * msg = (toms_msg__srv__CrawlerService_Response *)allocator.allocate(sizeof(toms_msg__srv__CrawlerService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(toms_msg__srv__CrawlerService_Response));
  bool success = toms_msg__srv__CrawlerService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
toms_msg__srv__CrawlerService_Response__Sequence__init(toms_msg__srv__CrawlerService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  toms_msg__srv__CrawlerService_Response * data = NULL;

  if (size) {
    data = (toms_msg__srv__CrawlerService_Response *)allocator.zero_allocate(size, sizeof(toms_msg__srv__CrawlerService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = toms_msg__srv__CrawlerService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        toms_msg__srv__CrawlerService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
toms_msg__srv__CrawlerService_Response__Sequence__fini(toms_msg__srv__CrawlerService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      toms_msg__srv__CrawlerService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  toms_msg__srv__CrawlerService_Response__Sequence * array = (toms_msg__srv__CrawlerService_Response__Sequence *)allocator.allocate(sizeof(toms_msg__srv__CrawlerService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = toms_msg__srv__CrawlerService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
toms_msg__srv__CrawlerService_Response__Sequence__destroy(toms_msg__srv__CrawlerService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    toms_msg__srv__CrawlerService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
toms_msg__srv__CrawlerService_Response__Sequence__are_equal(const toms_msg__srv__CrawlerService_Response__Sequence * lhs, const toms_msg__srv__CrawlerService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!toms_msg__srv__CrawlerService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  toms_msg__srv__CrawlerService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(toms_msg__srv__CrawlerService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    toms_msg__srv__CrawlerService_Response * data =
      (toms_msg__srv__CrawlerService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!toms_msg__srv__CrawlerService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          toms_msg__srv__CrawlerService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!toms_msg__srv__CrawlerService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
