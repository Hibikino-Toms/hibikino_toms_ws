...
static const _TomatoData_type_support_symbol_names_t _TomatoData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, toms_msg, msg, TomatoData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, toms_msg, msg, TomatoData)),
  }
};
...
{
  return &::toms_msg::msg::rosidl_typesupport_cpp::TomatoData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, toms_msg, msg, TomatoData)() {
  return get_message_type_support_handle<toms_msg::msg::TomatoData>();
}
