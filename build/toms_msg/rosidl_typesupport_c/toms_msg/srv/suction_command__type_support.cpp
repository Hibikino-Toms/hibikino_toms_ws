...
static const _SuctionCommand_Request_type_support_symbol_names_t _SuctionCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, toms_msg, srv, SuctionCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, toms_msg, srv, SuctionCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, toms_msg, srv, SuctionCommand_Request)() {
  return &::toms_msg::srv::rosidl_typesupport_c::SuctionCommand_Request_message_type_support_handle;
}
...
static const _SuctionCommand_Response_type_support_symbol_names_t _SuctionCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, toms_msg, srv, SuctionCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, toms_msg, srv, SuctionCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, toms_msg, srv, SuctionCommand_Response)() {
  return &::toms_msg::srv::rosidl_typesupport_c::SuctionCommand_Response_message_type_support_handle;
}
...
static const _SuctionCommand_type_support_symbol_names_t _SuctionCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, toms_msg, srv, SuctionCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, toms_msg, srv, SuctionCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, toms_msg, srv, SuctionCommand)() {
  return &::toms_msg::srv::rosidl_typesupport_c::SuctionCommand_service_type_support_handle;
}
