...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'teleop_automation = teleop_demo_pkg.teleop_automation:main',
            'teleop_demo_launch = teleop_demo_pkg.teleop_demo_launch:main',
            'crawler_automation = teleop_demo_pkg.crawler_automation:main',
        ],
    },
)
