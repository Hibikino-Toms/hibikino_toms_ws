...
class CrawlerControllerSerial(Node):
    ...
    def __init__(self):
        ...
        # YAMLファイルのパスをROS2パラメータとして宣言・取得
        # あなたのワークスペース内の正しいパスを指定してください
        default_yaml_path = '/home/ylab/hibikino_toms_ws/module/set_params.yaml'
        self.declare_parameter('yaml_file_path', default_yaml_path)
        yaml_path = self.get_parameter('yaml_file_path').get_parameter_value().string_value
