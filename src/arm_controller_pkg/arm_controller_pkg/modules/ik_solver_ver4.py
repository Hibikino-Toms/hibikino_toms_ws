...
class InverseKinematicsSolver:
    ...
    def ik_ang2dxl_ang(self, ik_angles_list):
        angles_lists_motor = []
        angles_lists_motor = [ ik_angles_list[0] + 90, (ik_angles_list[1] + 180) %360, (ik_angles_list[2] + 180) %360]
    ...
    def dxl_ang2ik_ang(self, motor_angles_list):
        angles_lists_ik = []
        angles_lists_ik = [motor_angles_list[0] - 90, (motor_angles_list[1] - 180) %360, (motor_angles_list[2] - 180) %360]
