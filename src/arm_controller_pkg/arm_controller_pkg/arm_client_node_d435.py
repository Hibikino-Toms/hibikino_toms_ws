...
class ArmClientNodeD435(Node):
    def __init__(self):
        super().__init__('arm_client_node_d435')
        self.arm_client = self.create_client(ArmService,"arm_service_d435")
