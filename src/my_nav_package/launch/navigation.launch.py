...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        'map',
        # default_value=os.path.join(pkg_share, 'maps', 'maps.yaml'),
        default_value='/home/ylab/hibikino_toms_ws/src/my_nav_package/maps/maps.yaml',
    ...
    #     arguments=['--x', '0.0', '--y', '0.0', '--z', '0.0', '--yaw', '0.0', '--pitch', '0.0', '--roll', '0.0', '--frame-id', 'odom', '--child-frame-id', 'base_link']
    # )

    # tf_link_to_foot = Node(
    #     package='tf2_ros',
    #     executable='static_transform_publisher',
    #     name='tf_link_to_foot',
    ...
    tf_base_to_livox = Node(
        ...
        arguments=['--x', '0.0', '--y', '0.0', '--z', '0.061', '--yaw', '0.0', '--pitch', '0.0', '--roll', '0.0', '--frame-id', 'base_footprint', '--child-frame-id', 'livox_frame']
    )
